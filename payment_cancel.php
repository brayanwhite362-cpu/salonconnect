...
<head>
    ...
    <title>Payment Cancelled | SalonConnect</title>
...
<body>
    <div class="cancel-card">
        ...
        <h2 style="color: #c8a14a;">Payment Cancelled</h2>
        <p class="muted">Your payment was cancelled. Your booking is still pending.</p>
        <a href="book.php?salon_id=<?= $booking_id ?>" class="btn-home">Try Again</a>
    </div>
</body>
</html>